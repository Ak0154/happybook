...
import { ThemeTogglerButton, type ThemeTogglerButtonProps } from '@/components/animate-ui/components/buttons/theme-toggler';
import {
    Dialog,
    DialogContent,
    DialogHeader,
...
function ThemeTogglerButtonDemo({
  variant,
  size,
  direction,
  system,
...
export default function DashboardPage() {
    ...
    useEffect(() => {
        ...
        if (email) {
            ...
            const storedUser = localStorage.getItem('happybook-user');
            if (storedUser) {
